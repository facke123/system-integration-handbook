...
4. **信息安全系统工程能力成熟度模型（ISSE-CMM / SSE-CMM）深度全解（教材第 295~302 页）**：
   ...
   - **高频对比：ISSE-CMM vs 软件能力成熟度模型 CMMI 跨界辨析**：
     ...
     | **级别名称** | **1.非正规实施级 $\rightarrow$ 2.规划与跟踪级 $\rightarrow$ 3.充分定义级 $\rightarrow$ 4.量化控制级 $\rightarrow$ 5.持续改进级** | **1.初始级 $\rightarrow$ 2.已管理级 $\rightarrow$ 3.已定义级 $\rightarrow$ 4.量化管理级 $\rightarrow$ 5.优化级** |
